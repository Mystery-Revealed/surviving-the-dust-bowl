...
app.get('/healthz', (_req, res) =>
  res.json({ ok: true, service: 'dust-bowl', liveSessions: manager.registry.sessions.size }));
...
server.listen(config.port, () => {
  console.log(`[dust-bowl] listening on :${config.port} — sessions live in memory only`);
});
